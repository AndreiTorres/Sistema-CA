...
public function listar(){
	$sql="SELECT * FROM tipousuario  WHERE idtipousuario = 2 OR idtipousuario = 3";
	return ejecutarConsulta($sql);
}
//listar y mostrar en selct
public function select(){
	$sql="SELECT * FROM tipousuario WHERE idtipousuario = 2 OR idtipousuario = 3 ORDER BY nombre ASC";
	return ejecutarConsulta($sql);
}
}
