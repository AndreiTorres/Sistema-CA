                ...
                ,
            {
                ...
                customize: function (doc) {
                    ...
                    for (i = 0; i < numCols; i++) {
                        ...
                        if (table[0][i].text == "Tipo" + tipo_entrada) {
                            table[0][i].text = "Tipo";
                        }
                    }
...
function editartipo(idasistencia) {
    bootbox.dialog({
        ...
        message: "<form><label>Tipo:</label><br><select name='selecttipo' id='selecttipo1'><option value='Asistencia'>Asistencia</option><option value='Retardo'>Retardo</option><option value='Incidencia'>Incidencia</option></select>" +
