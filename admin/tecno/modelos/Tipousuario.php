...
public function listar(){
	$sql="SELECT * FROM tipousuario WHERE idtipousuario = 4 OR idtipousuario = 8";
	return ejecutarConsulta($sql);
}
//listar y mostrar en selct
public function select(){
	$sql="SELECT * FROM tipousuario WHERE idtipousuario = 4 OR idtipousuario = 8 ORDER BY nombre ASC";
	return ejecutarConsulta($sql);
}
